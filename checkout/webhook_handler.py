        ...
        while attempt <= 5:
            try:
                order = Order.objects.get(
                    first_name__iexact=shipping_details.name1,
                    last_name__iexact=shipping_details.name2,
        ...
        if order_exists:
            ...
            try:
                order = Order.objects.create(
                    first_name=shipping_details.name1,
                    last_name=shipping_details.name2,
